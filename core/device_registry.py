...
REGISTRY_DIR = Path(_cfg_env).expanduser() if _cfg_env else Path.home() / ".config" / "moke_scan"
...
def _default_registry() -> List[dict]:
    ...
    return [
        ...
        {
            "name":            "AttoDRY",
            "tango_path":      "hpp-N42/attoDRY/attoDRY",
            "type":            "cryostat",
            "trigger_cmd":     "",
            "integ_time_attr": "",
            "channels": [
                {"attr": "MagneticField",       "label": "Field",        "unit": "T"},
                {"attr": "Temperature",         "label": "Temperature",  "unit": "K"},
                {"attr": "VtiTemperature",      "label": "VTI Temp",     "unit": "K"},
                {"attr": "MagnetTemperature",   "label": "Magnet Temp",  "unit": "K"},
                {"attr": "ReservoirTemperature","label": "Reservoir T",  "unit": "K"},
                {"attr": "CryostatInPressure",  "label": "Pressure In",  "unit": "mbar"},
                {"attr": "CryostatOutPressure", "label": "Pressure Out", "unit": "mbar"},
                {"attr": "SampleHeaterPower",   "label": "Sample Heater","unit": "W"},
                {"attr": "VtiHeaterPower",      "label": "VTI Heater",   "unit": "W"},
            ],
        },
    ]
